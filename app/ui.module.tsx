...
export function Footer() {
  return (
    <footer className="flex gap-2 md:px-6 p-3 justify-between items-center">
      <a href="https://github.com/aelithron/novatea" target="_blank" className="flex items-center text-slate-500 hover:text-sky-500"><FontAwesomeIcon icon={faGithub} /> <p className="ml-1 underline">source</p></a>
