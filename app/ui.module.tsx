...
export function Header() {
  return (
    <div className="flex flex-col md:flex-row items-center md:justify-between gap-2 p-2 md:px-6">
      <h1 className="text-xl font-semibold bg-linear-to-br from-violet-300 to-violet-500 text-transparent bg-clip-text">nova :3</h1>
      <div className="flex gap-4 justify-between">
        ...
        <Link href={"/contact"} className={`hover:text-sky-500`}><FontAwesomeIcon icon={faComment} /> contact</Link>
      </div>
    </div>
  );
}